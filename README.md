...
The selected object is displayed as:

RED → TARGET LOCKED

Other valid detections are displayed as:
...
1. Press **Ctrl + S**
2. **Do not run Git commands yet.**
3. Scroll through the README and check that headings look like headings, bullet points look like bullets, and the code blocks are formatted.

Then send me a **screenshot of the bottom part of the README** around `Author → License → Demo`.

We'll verify it before committing, so we don't keep pushing broken README form